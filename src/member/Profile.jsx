...
const Profile = () => {
  ...
  const filteredBorrowings = () => {
    ...
    if (activeBorrowingTab === "active") return borrowings.filter(b => b.status === "PICKED_UP");
    ...
    if (activeBorrowingTab === "overdue") return borrowings.filter(b => b.status === "CANCELLED");
    return borrowings;
  };
  ...
  const borrowingStats = {
    ...
    overdue: borrowings.filter(b => b.status === "CANCELLED").length
  };
